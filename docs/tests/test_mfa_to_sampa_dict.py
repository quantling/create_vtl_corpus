...
def test_each_phone():
    ...
    with open(path_no_phoneme, "rb") as handle:
    ...
    for i, phone in enumerate(phones): #now the actual test
        ...
        sf.write(os.path.join(phones_folder_path,f"{phone}.wav"), wav_syn, wav_syn_sr) # ypou can listen to the phonemes to check if they are what you expect
