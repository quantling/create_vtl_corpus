...
TARGET_DIR = '../compare_to_matlab/python_ges'

with open('../compare_to_matlab/utterance_list_python.utt', 'rt') as uttfile:
    ...
    for ii, line in enumerate(uttfile):
        ...
        try:
            generate_gestural_score(f'{TARGET_DIR}/{base_name}.ges', sampa, durations)
